...
<div class="container">
    <table id="cart" class="table table-hover " style="margin-top:3rem;">
        <thead style="background-color:mediumorchid; color:white">
            <tr>
        ...
        <tbody style="background-color:plum; color:darkviolet">
            @php $total = 0 @endphp
            @if(session('cart'))
        ...
        <tfoot>
            <tr>
                ...
                <td colspan="5" class="text-right">
                    <h3><strong style="color: white;">Total Rp.{{ $total }}</strong></h3>
                </td>
            </tr>
            <tr>
                <td colspan="5" class="text-right">

                    <a href="/checkout" class="btn" style="float:right;background-color:cadetblue;color:white">Checkout</a>
                    <a href="{{ url('/') }}" class="btn btn-warning" style="float:right;background-color:mediumorchid;color:white"><i class="fa fa-angle-left" style="color:white"></i>Kembali Belanja</a>
                </td>
            </tr>
        </tfoot>
    </table>
