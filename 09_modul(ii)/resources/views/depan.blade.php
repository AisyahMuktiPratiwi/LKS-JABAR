...
<div class="container">
    ...
    <div class="row">
        <div class="etalase">
            <div class="col-4">
                <div class="card" style="background-color: lavender;width:18rem;margin-top:2rem;margin-bottom:2rem;margin-left:2rem;">
                    <img class="card-img-top" src="{{ asset('img/1.jpeg') }}" alt="" style="width:15rem;height:15rem;margin-top:1rem; margin-left:1rem;" >
                    <div class="card-body" style="margin-top:1rem;">
                        <h4 class="card-title" style="color:blueviolet">Laptop HP</h4>
                        <p class="card-text"><button class="btn btn-sm" style="color:white;background-color:blueviolet;margin-left:8rem;border-radius:150px;">Rp.5.000.000</button></p>
                        <a href="" class="btn" style="background-color:plum;color:white">Detail</a>
                        <a href="" class="btn" style="background-color:seagreen;color:white"><img src="{{ asset('img/a.png') }}" alt="" width="30px;"></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="etalase">
            <div class="col-4">
                <div class="card" style="background-color: lavender;width:18rem;margin-top:2rem;margin-bottom:2rem;margin-left:2rem;">
                    <img class="card-img-top" src="{{ asset('img/3.jpeg') }}" alt="" style="width:15rem;height:15rem;margin-top:1rem; margin-left:1rem;" >
                    <div class="card-body" style="margin-top:1rem;">
                        <h4 class="card-title" style="color:blueviolet">Oppo Reno 5</h4>
                        <p class="card-text"><button class="btn btn-sm" style="color:white;background-color:blueviolet;margin-left:8rem;border-radius:150px;">Rp.5.000.000</button></p>
                        <a href="" class="btn" style="background-color:plum;color:white">Detail</a>
                        <a href="" class="btn" style="background-color:seagreen;color:white"><img src="{{ asset('img/a.png') }}" alt="" width="30px;"></a>
                    </div>
        ...
        <div class="etalase">
            <div class="col-4">
                <div class="card" style="background-color: lavender;width:18rem;margin-top:2rem;margin-bottom:2rem;margin-left:2rem;">
                    <img class="card-img-top" src="{{ asset('img/5.jpeg') }}" alt="" style="width:15rem;height:15rem;margin-top:1rem; margin-left:1rem;" >
                    <div class="card-body" style="margin-top:1rem;">
                        <h4 class="card-title" style="color:blueviolet">IMAc 27"</h4>
                        <p class="card-text"><button class="btn btn-sm" style="color:white;background-color:blueviolet;margin-left:8rem;border-radius:150px;">Rp.5.000.000</button></p>
                        <a href="" class="btn" style="background-color:plum;color:white">Detail</a>
                        <a href="" class="btn" style="background-color:seagreen;color:white"><img src="{{ asset('img/a.png') }}" alt="" width="30px;"></a>
                    </div>
        ...
        <div class="etalase">
            <div class="col-4">
                <div class="card" style="background-color: lavender;width:18rem;margin-top:2rem;margin-bottom:2rem;margin-left:2rem;">
                    <img class="card-img-top" src="{{ asset('img/7.jpeg') }}" alt="" style="width:15rem;height:15rem;margin-top:1rem; margin-left:1rem;" >
                    <div class="card-body" style="margin-top:1rem;">
                        <h4 class="card-title" style="color:blueviolet">Smart Tv LG</h4>
                        <p class="card-text"><button class="btn btn-sm" style="color:white;background-color:blueviolet;margin-left:8rem;border-radius:150px;">Rp.5.000.000</button></p>
                        <a href="" class="btn" style="background-color:plum;color:white">Detail</a>
                        <a href="" class="btn" style="background-color:seagreen;color:white"><img src="{{ asset('img/a.png') }}" alt="" width="30px;"></a>
                    </div>
        ...
        <div class="etalase">
            <div class="col-4">
                <div class="card" style="background-color: lavender;width:18rem;margin-top:2rem;margin-bottom:2rem;margin-left:2rem;">
                    <img class="card-img-top" src="{{ asset('img/2.jpeg') }}" alt="" style="width:15rem;height:15rem;margin-top:1rem; margin-left:1rem;" >
                    <div class="card-body" style="margin-top:1rem;">
                        <h4 class="card-title" style="color:blueviolet">Laptop Asus</h4>
                        <p class="card-text"><button class="btn btn-sm" style="color:white;background-color:blueviolet;margin-left:8rem;border-radius:150px;">Rp.5.000.000</button></p>
                        <a href="" class="btn" style="background-color:plum;color:white">Detail</a>
                        <a href="" class="btn" style="background-color:seagreen;color:white"><img src="{{ asset('img/a.png') }}" alt="" width="30px;"></a>
                    </div>
        ...
        <div class="etalase">
            <div class="col-4">
                <div class="card" style="background-color: lavender;width:18rem;margin-top:2rem;margin-bottom:2rem;margin-left:2rem;">
                    <img class="card-img-top" src="{{ asset('img/4.jpeg') }}" alt="" style="width:15rem;height:15rem;margin-top:1rem; margin-left:1rem;" >
                    <div class="card-body" style="margin-top:1rem;">
                        <h4 class="card-title" style="color:blueviolet">Samsung Galaxi A5s</h4>
                        <p class="card-text"><button class="btn btn-sm" style="color:white;background-color:blueviolet;margin-left:8rem;border-radius:150px;">Rp.5.000.000</button></p>
                        <a href="" class="btn" style="background-color:plum;color:white">Detail</a>
                        <a href="" class="btn" style="background-color:seagreen;color:white"><img src="{{ asset('img/a.png') }}" alt="" width="30px;"></a>
                    </div>
